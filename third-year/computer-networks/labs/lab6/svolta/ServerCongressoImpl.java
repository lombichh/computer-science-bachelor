...
public class ServerCongressoImpl extends UnicastRemoteObject implements
  ...
  public synchronized int registrazione(int giorno, String sessione, String speaker)
  ...
  // Ritorno il campo
  public synchronized Programma programma(int giorno) throws RemoteException {
