	...
	<body onload="">
		...
		if (file.exists()) {
            ...
            while (fileDaContare && (fileLine = bufferedReader.readLine()) != null) {
				if (fileLine.startWith("Il numero di caratteri alfabetici del file è uguale a")) {
					numConteggi++;
            ...
            if (fileDaContare) {
                ...
                while ((car = bufferedReader.read()) != null) {
                	if (Character.isLetter(car)) numCar++;
                }
        ...
        <%
        		...
        		fileWriter.write("Il numero di caratteri alfabetici del file è uguale a " + loginInfo);
        	} else {
        %>
