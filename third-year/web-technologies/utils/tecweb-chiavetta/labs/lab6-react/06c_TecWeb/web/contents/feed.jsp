...
<%@ page import="it.unibo.tw.web.pojo.RandomNumber"%>
<%@ page import="it.unibo.tw.web.pojo.FeedDb"%>
...
<jsp:useBean id="feedDb" class="it.unibo.tw.web.pojo.FeedDb"  scope = "application"/>
<%
...
// recupero il tipo di categoria cercata dai parametri della richiesta
	...
	List<RandomNumber> someFeeds = feedDb.find(category);
	
	// li stampo su out
	for ( RandomNumber feed : someFeeds ) {
%>
		<item>
